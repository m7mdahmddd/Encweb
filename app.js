...
function updateBadgeUI() {
    ...
    if (chatBadge) {
        if (unreadChatCount > 0) {
            chatBadge.innerText = unreadChatCount > 99 ? '99+' : unreadChatCount;
    ...
    if (friendsBadge) {
        if (unreadFriendsCount > 0) {
            friendsBadge.innerText = unreadFriendsCount > 99 ? '99+' : unreadFriendsCount;
            friendsBadge.style.display = 'inline-flex';
        } else {
